...
## Steps to use Variable fonts

- Where I can get variable fonts - Google Fonts, v-fonts.com,
- to convert ttf2 to woff2 (as woof allows much more compression) - everythingfonts.com

- convert variable font to woff2 and save it inside public-fonts folder
- Font used
